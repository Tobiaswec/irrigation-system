...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Wilkommen im Bewässerungssystem';
...
const HelloWorldIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hallo, freut mich dich zu sehen!';
...
exports.handler = Alexa.SkillBuilders.custom()
    .addRequestHandlers(
        ...
        WaterIntentHandler,
        WaterStrongIntentHandler,
        CurrentMoistureIntentHandler,
        AvgMoistureIntentHandler,
